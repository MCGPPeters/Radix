...
namespace Radix.Result
{
    ...
    {
        public static Result<T, TError> Ok<T, TError>(T t) => new Ok<T, TError>(t);

        public static Result<T, TError> Error<T, TError>(TError error) => new Error<T, TError>(error);

        public static Result<TResult, TError> Bind<T, TResult, TError>(this Result<T, TError> result, Func<T, Result<TResult, TError>> function) => result switch
        {
        ...
        public static Result<TResult, TError> Select<T, TResult, TError>(this Result<T, TError> result, Func<T, TResult> function) => Map(result, function);


        public static Result<T, TErrorResult> MapError<T, TError, TErrorResult>(this Result<T, TError> result, Func<TError, TErrorResult> function) => result switch
        {
        ...
        public static Result<TResult, TError> Apply<T, TResult, TError>(this Result<Func<T, TResult>, TError> fResult, Result<T, TError> xResult) => (fResult, xResult) switch
        {
