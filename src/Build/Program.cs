    ...
    static async Task Main(string[] args)
    {
        ...
        foreach (var project in projects)
        {
            ...
            Target(packTarget, DependsOn(Clean),
                packableProjects,
                packableProject => Run("dotnet", $"pack {packableProject} --no-build  -p:PackageVersion={nugetVersion};RepositoryType=git;RepositoryCommit={gitCommitId};\" -c Release -o {ArtifactsDir}"));
