...
/// </returns>
public delegate Task<Result<ExistingVersion, AppendEventsError>> AppendEvents<TFormat>(Aggregate.Id id, Version expectedVersion, EventStreamDescriptor eventStreamDescriptor,
